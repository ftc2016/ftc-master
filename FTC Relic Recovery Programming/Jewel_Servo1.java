...
public class Jewel_Servo1 extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        jewelVertical = (Servo) hardwareMap.get("jewel_vertical");
        jewelHorizontal = (Servo) hardwareMap.get("jewel_horizontal");
        ...
        while (opModeIsActive()) {
            ...
            if (jewelColor.blue() <= 7) {
               ...
               // jewelHorizontal.setDirection(Servo.Direction.FORWARD);
                jewelHorizontal.setPosition(.25);
            } else {
                telemetry.addData("Red Color:", jewelColor.red());
                telemetry.addData("Blue Color:", jewelColor.blue());
                telemetry.update();
